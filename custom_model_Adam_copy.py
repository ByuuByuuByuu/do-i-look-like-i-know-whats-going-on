...
class QModel:
    ...
    def save(self, W1, b1, W2, b2, m_t_W1, v_t_W1, m_t_b1, v_t_b1, m_t_W2, v_t_W2, m_t_b2, v_t_b2, t):
        ...
        model_params = {
            ...
            'W2': W2.tolist(),
            'b2': b2.tolist(),
            'm_t_W1': m_t_W1.tolist(),
            'v_t_W1': v_t_W1.tolist(),
            'm_t_b1': m_t_b1.tolist(),
            'v_t_b1': v_t_b1.tolist(),
            'm_t_W2': m_t_W2.tolist(),
            'v_t_W2': v_t_W2.tolist(),
            'm_t_b2': m_t_b2.tolist(),
            'v_t_b2': v_t_b2.tolist(),
            't': t
        }
...
class QTrainer:
    ...
    def update_params(self, W1, b1, W2, b2, dW1, db1, dW2, db2, m_t_W1, v_t_W1, m_t_b1, v_t_b1, m_t_W2, v_t_W2, m_t_b2, v_t_b2, t, sample_size_counter):
        ...
        W1, m_t_W1, v_t_W1 = self.optimizer.optimize(W1, dW1, m_t_W1, v_t_W1, sample_size_counter)
        b1, m_t_b1, v_t_b1 = self.optimizer.optimize(b1, db1, m_t_b1, v_t_b1, sample_size_counter)
        W2, m_t_W2, v_t_W2 = self.optimizer.optimize(W2, dW2, m_t_W2, v_t_W2, sample_size_counter)
        b2, m_t_b2, v_t_b2  = self.optimizer.optimize(b2, db2, m_t_b2, v_t_b2, sample_size_counter)
        t += 1
    ...
    def train_step(self, W1, b1, W2, b2, state, action, reward, next_state, done, counter, sample_size_counter, m_t_W1, v_t_W1, m_t_b1, v_t_b1, m_t_W2, v_t_W2, m_t_b2, v_t_b2, t):
        ...
        W1, b1, W2, b2, m_t_W1, v_t_W1, m_t_b1, v_t_b1, m_t_W2, v_t_W2, m_t_b2, v_t_b2, t = self.update_params(W1, b1, W2, b2, dW1, db1, dW2, db2, m_t_W1, v_t_W1, m_t_b1, v_t_b1, m_t_W2, v_t_W2, m_t_b2, v_t_b2, t, sample_size_counter)
...
class AdamOptimizer:
    ...
    def optimize(self, param, grad, m_t, v_t, sample_size_counter):
        if self.t >= 1000:
            self.t = 1000 + sample_size_counter
        ...
        if self.t == 0:
            m_t_hat = m_t / (1 - self.beta1 ** self.t + self.epsilon)
            v_t_hat = v_t / (1 - self.beta2 ** self.t + self.epsilon)

        else:
            m_t_hat = m_t / (1 - self.beta1 ** self.t)
            v_t_hat = v_t / (1 - self.beta2 ** self.t)

        # print("mt hat", m_t_hat)
        # print("vt hat", v_t_hat)
