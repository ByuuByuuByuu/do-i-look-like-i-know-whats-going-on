...
def train():
    ...
    while True:
        ...
        # get move
        selected_move = agent.get_action(current_state)
        ...
        # train short memory
        agent.train_short_memory(current_state, selected_move, reward, new_state, done)
