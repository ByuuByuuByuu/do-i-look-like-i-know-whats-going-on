...
from custom_model_Adam import QModel, QTrainer, AdamOptimizer
...
class Agent:
    ...
    def train_long_memory(self, W1, b1, W2, b2, counter, m_t_W1, v_t_W1, m_t_b1, v_t_b1, m_t_W2, v_t_W2, m_t_b2, v_t_b2, t):
...
def train():
    ...
    while True:
        ...
        if done:
            ...
            game.reset()
            agent.n_games += 1
            W1, b1, W2, b2, agent.optimizer.m_t_W1, agent.optimizer.v_t_W1, agent.optimizer.m_t_b1, agent.optimizer.v_t_b1, agent.optimizer.m_t_W2, agent.optimizer.v_t_W2, agent.optimizer.m_t_b2, agent.optimizer.v_t_b2, agent.optimizer.t  = agent.train_long_memory(W1, b1, W2, b2, counter, agent.optimizer.m_t_W1, 
                                        agent.optimizer.v_t_W1, 
                                        agent.optimizer.m_t_b1, 
                                        agent.optimizer.v_t_b1, 
                                        agent.optimizer.m_t_W2, 
